...
fn create_specta_builder() -> tauri_specta::Builder<tauri::Wry> {
    tauri_specta::Builder::<tauri::Wry>::new()
        .commands(tauri_specta::collect_commands![
            ...
            commands::backend::backend_get_home_locations,
            commands::backend::get_home_location_id,
            commands::backend::set_home_location_id,
            ...
            commands::inventory::inventory_collection_create,
            commands::inventory::inventory_collection_update,
            commands::inventory::inventory_collection_delete,
            commands::inventory::inventory_migrate_legacy,
            commands::inventory::inventory_sync_from_backend,
            ...
            commands::orgs::org_list_my_orgs,
            commands::orgs::org_create,
            commands::orgs::org_get,
            commands::orgs::org_update,
            commands::orgs::org_delete,
            commands::orgs::org_list_roles,
            commands::orgs::org_create_role,
            commands::orgs::org_update_role,
            commands::orgs::org_delete_role,
            commands::orgs::org_update_member,
            commands::orgs::org_remove_member,
            commands::orgs::org_transfer_leadership,
            commands::orgs::org_list_invitations,
            commands::orgs::org_create_invitation,
            commands::orgs::org_cancel_invitation,
            ...
            commands::orgs::org_reject_application,
            commands::orgs::org_list_inventory,
            commands::orgs::org_add_inventory_entry,
            commands::orgs::org_update_inventory_entry,
            commands::orgs::org_delete_inventory_entry,
            commands::orgs::org_remove_inventory_quantity,
            commands::orgs::org_transfer_inventory,
            commands::orgs::org_list_collections,
            commands::orgs::org_create_collection,
            commands::orgs::org_update_collection,
            commands::orgs::org_delete_collection,
        ])
}
