...
<template>
  <div class="space-y-3">
    ...
    <div v-if="roleDialog" class="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
      <div class="bg-[#1a1d24] border border-white/10 rounded-xl w-full max-w-md mx-4 p-6 space-y-4 max-h-[90vh] overflow-y-auto">
        <div class="flex items-center justify-between">
          ...
          <button @click="roleDialog = null" class="text-white/40 hover:text-white/80 transition-colors">
